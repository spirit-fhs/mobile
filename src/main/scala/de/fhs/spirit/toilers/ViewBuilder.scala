...
import de.fhs.spirit.activities.NewsSingle
import android.graphics.drawable.Drawable
import de.fhs.spirit.toilers.JsonProcessor.{NewsComment, DegreeClassExt, News}
